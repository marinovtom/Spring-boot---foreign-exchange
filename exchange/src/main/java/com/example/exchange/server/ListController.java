...
public class ListController {
	...
	public List<Conversion> getConversionListFor(@RequestParam(required=false) Long id, @RequestParam(required=false) String date, @RequestParam int pageNo) throws java.text.ParseException
	{
